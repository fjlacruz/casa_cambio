...
<body onload="nobackbutton();">
    ...
    <div class="container" id="solicitudes">
        <div class="col-md-3">
            ...
            <p class="clearfix visible-lg">&nbsp;</p>
            <p class="clearfix visible-lg">&nbsp;</p>
            <div class="list-group visible-lg" style="box-shadow: 2px 2px 5px #666;">
                <a href="<?php echo BASE_URL() ?>principal/dashboard" class="list-group-item"><i class="fa fa-gears"></i>&nbsp;Configuraciones</a>
                <a href="<?php echo BASE_URL() ?>configuraciones/caja" class="list-group-item"><i class="fa fa-dollar"></i>&nbsp;Caja</a>
                <a href="<?php echo BASE_URL() ?>transferencias/pagoEfectivo" class="list-group-item"><i class="fa fa-dollar"></i>&nbsp;Pago Efectivo</a>
                <a href="<?php echo BASE_URL() ?>transferencias/historico" class="list-group-item"><i class="fa fa-file-text"></i>&nbsp;Hist&oacute;rico</a>
                <a href="<?php echo BASE_URL() ?>transferencias/rechazadas" class="list-group-item"><i class="fa fa-dollar"></i>&nbsp;Trasnferencias Rechazadas</a>
                <a href="<?php echo BASE_URL() ?>administracion/usuarios" class="list-group-item"><i class="fa fa-users"></i>&nbsp;Usuarios</a>
                <a href="<?php echo BASE_URL() ?>administracion/usuarioModificar" class="list-group-item"><i class="fa fa-user"></i>&nbsp;Mi Usuario</a>
            </div>
        ...
        <div class="col-md-6">
            <p>&nbsp;</p>
            <p>&nbsp;&nbsp;&nbsp;<span class="label label-default" style="box-shadow: 2px 2px 10px #666;"><strong>Solicitudes Pendientes</strong></span>
                <span class="label label-danger" id="pendientes" style="box-shadow: 2px 2px 10px #666;">Solicitudes Pendientes</span></p>
            <div id="tabla_solicitudes_adm"></div>
        </div>
        <div class="col-md-3">
            <br> <br> <br>
        ...
        <div class="container">
            ...
            <div class="col-sm-6"><br>
                    ...
                    <div class="panel panel-default" style="box-shadow: 2px 2px 10px #666;">
                        ...
                        <div class="panel-body">
                            <div id="transferencias_adjuntos"></div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="formulario_registrar_solicitud2" method="POST" action="" enctype="multipart/form-data">
                            <input type="hidden" id="id_transferencia" name="id_transferencia">
                            <input type="hidden" id="id_banco" name="id_banco">
                            <input type="hidden" id="monto_a_transferir" name="monto_a_transferir">
                            <div class="form-group">
                                <label class="control-label col-sm-2">Adjuntar:</label>
                                <div class="col-sm-10">
                                    <input type='file' name='adjunto_resp' id="adjunto_resp" class="form-control" onchange="return fileValidation()">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <button type="button" class="btn bg-primary btn-block" style="box-shadow: 2px 2px 10px #666;" onclick="myFunction(1)"><i class="fa fa-arrow-left"></i> Regresar</button><br>
                                    <button type="button" class="btn btn-danger btn-block" style="box-shadow: 2px 2px 10px #666; display:block;" id="cancelar_solicitud"><i class="fa fa-trash"></i> Cancelar por Error..!!</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    $(document).ready(function() {
        var refreshId = setInterval(function() {
            $("#tabla_solicitudes_adm").load("<?php echo base_url() ?>index.php/Transferencias/solicitudes_adm")
                .error(function() {
                    alert("Error");
                });
        }, 1000);
    ...
    $(document).ready(function() {
        var refreshId = setInterval(function() {
            $("#pendientes").load("<?php echo base_url() ?>index.php/Transferencias/contar_solicitudes_pendientes")
                .error(function() {
                    alert("Error");
                });
        }, 1000);
    ...
    $(document).ready(function() {
        $('#formulario_registrar_solicitud2').formValidation({
            fields: {
            ...
            var formData = new FormData($("#formulario_registrar_solicitud2")[0]);
            $.ajax({
                url: "<?php echo base_url() . 'index.php/Transferencias/procesar_solicitud'; ?>",
                method: 'POST',
                data: formData,
                cache: false,
                processData: false,
                ...
                beforeSend: function() {
                   ...
                   // $('#formulario_registrar_solicitud2').bootstrapValidator("resetForm", true);
                   // $('#adjunto_resp').val('');
                },
            }).success(function(response) {

                alertify.log("Solicitud Procesada Exitosamente...!!");
                ...
                //$('#formulario_registrar_solicitud2').bootstrapValidator("resetForm", true);
                document.getElementById("adjunto_resp").value = "";
                $('#adjunto_resp').val('');
                myFunction(1);
                leerSolicitudes();
    ...
    function fileValidation() {
        var fileInput = document.getElementById('adjunto_resp');
    ...
    function limpiarForm() {
        ...
        $("#formulario_registrar_solicitud2")[0].bootstrapValidator("resetForm", true);
                $('#adjunto_resp').val('');
