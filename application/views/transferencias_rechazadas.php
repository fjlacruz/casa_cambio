...
<body onload="nobackbutton();">
    ...
    <div class="container" id="solicitudes">
        ...
        <div class="col-md-6">
            ...
            <p>&nbsp;&nbsp;&nbsp;<span class="label label-default" style="box-shadow: 2px 2px 10px #666;"><strong>Solicitudes Rechazadas</strong></span>
...
<script>
    ...
    function leerDatos() {
        $.get("<?php echo base_url() . 'index.php/Transferencias/transferenciasRechazadas'; ?>", {}, function(data, status) {
            var x = $("#historico").html(data);
        });
    }
